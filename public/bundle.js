...
const btnAgregarGasto$1 = document.getElementById("toggle-form-gasto");
const formulario$1 = document.getElementById("formulario-gasto");

const abrirFormulario = (tipo = "agregar-gasto") => {
  if (tipo === "editar-gasto") {
    formulario$1.querySelector(".formulario-gasto__titulo").innerText =
      "Editar Gasto";
    formulario$1.querySelector(".formulario-gasto__btn").innerText =
      "Editar gasto";
    formulario$1.dataset.tipo = "editar-gasto";
  } else {
    formulario$1.querySelector(".formulario-gasto__titulo").innerText =
      "Agregar Gasto";
    formulario$1.querySelector(".formulario-gasto__btn").innerText =
      "Agregar gasto";
    formulario$1.dataset.tipo = "agregar-gasto";
  }
  formulario$1.classList.add("formulario-gasto--active");
  btnAgregarGasto$1.classList.add("agregar-gasto__btn--active");
};

const cerrarFormulario = () => {
  formulario$1.classList.remove("formulario-gasto--active");
  btnAgregarGasto$1.classList.remove("agregar-gasto__btn--active");
};

btnAgregarGasto$1.addEventListener("click", (e) => {
  if (!btnAgregarGasto$1.classList.contains("agregar-gasto__btn--active")) {
    abrirFormulario();
  } else {
    cerrarFormulario();
  }
